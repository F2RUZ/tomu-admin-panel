        ...
        >
          <FormControl error={!!errors.title}>
            ...
            <Input
              ...
              placeholder="Masalan: 1-modul vazifalari"
              sx={inputSx}
            />
            {errors.title && (
              <FormHelperText
...
export default function HomeworkPage() {
  ...
  const { data: blocks, isLoading } = useQuery({
    queryKey: ["homeworkBlocks", courseId],
    queryFn: () => BlockService.getHomeworkBlocks(courseId),
    select: (res) =>
    ...
    <Box>
      ...
      {isLoading ? (
        <Box sx={{ display: "flex", justifyContent: "center", py: 8 }}>
          <CircularProgress
            sx={{
              ...
              "[data-joy-color-scheme='dark'] &": { color: "#f59e0b" },
            }}
          />
        </Box>
      ) : !blocks?.length ? (
        <EmptyState
          ...
          description="Uy vazifalarini bloklar ichida tartiblab qo'ying"
          action={{
            label: "Blok yaratish",
