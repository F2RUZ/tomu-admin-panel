// src/components/courses/sections/Grammar/GrammarModal/index.tsx
"use client";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isEdit && editData) {
        ...
        await GrammarService.update(editData.id, dto, setUploadProgress);
        useSnackbarStore.getState().success("Grammar yangilandi!");
      } else {
        ...
        await GrammarService.create(dto, setUploadProgress);
        useSnackbarStore
          .getState()
          .success("Grammar yaratildi! Vimeo da tayyorlanmoqda...");
      }
      onSuccess();
      onClose();
    } catch (err: any) {
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
            ...
            >
              {isEdit ? "Grammerni tahrirlash" : "Yangi Grammar"}
            </Typography>
          </Box>
          {!loading && (
        ...
        >
          <FormControl error={!!errors.title}>
            ...
            <Input
              ...
              placeholder="Masalan: Fe'l zamonlari"
              disabled={loading}
              sx={inputSx}
            />
            {errors.title && (
